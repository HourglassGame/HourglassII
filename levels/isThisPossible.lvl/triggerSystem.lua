...
local tempStore =
{
    ...
    {
        {
            attachment = {platform = nil, xOffset = 18 * 3200, yOffset = 6 * 3200},
            index = 1,
            width = 2 * 3200,
            height = 2 * 3200,
            collisionOverlap = 50,
		...
		{
            attachment = {platform = 1, xOffset = -3 * 3200, yOffset = 1 * 3200},
            index = 2,
            width = 2 * 3200,
            height = 2 * 3200,
            collisionOverlap = 50,
    ...
    protoButtons = {
		...
		bts.stickySwitch{
            attachment = {platform = nil, xOffset = 6 * 3200, yOffset = 7.25 * 3200},
            width = 800,
            height = 1600,
            timeDirection = 'forwards',
            triggerID = 2
