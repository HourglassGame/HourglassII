...
local tempStore = 
{
    ...
    {
        {
            attachment = {platform = nil, xOffset = 2.2 * 3200, yOffset = 4 * 3200},
            index = 2,
            width = 2 * 3200,
            height = 2 * 3200,
            collisionOverlap = 50,
    ...
    protoMutators = {
        bts.pickup{
            attachment = {platform = nil, xOffset = 11.25 * 3200, yOffset = 11.25 * 3200},
            width = 1600,
            height = 1600,
            timeDirection = 'forwards',
            triggerID = 1,
        ...
        bts.pickup{
            attachment = {platform = nil, xOffset = 25.25 * 3200, yOffset = 6.25 * 3200},
            width = 1600,
            height = 1600,
            timeDirection = 'forwards',
            triggerID = 2,
