...
public:
    ...
    mt::std::map<Ability,unsigned int>::type const& getPickups() const { return pickups_;}
...
private:
    ...
    mt::std::map<Ability,unsigned int>::type pickups_;
...
public:
    ...
    mt::std::map<Ability,unsigned int>::type const& getPickups() const { return guy_->getPickups();}
