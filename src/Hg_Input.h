...
public:
    Input();
    void updateState(hg::RenderWindow::InputState const &keyState, int mouseXTimelineOffset, int mouseXOfEndOfTimeline, std::size_t personalTimelineLength, int mouseOffX, int mouseOffY, double mouseScale);
