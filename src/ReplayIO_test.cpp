...
namespace {
    bool testReplaySavingAndLoading()
    {
        ...
        inputReplay.push_back(InputList(GuyInput(false, true, false, false, false, false, Ability::NO_ABILITY, FrameID(), 0, 0), 0));
        inputReplay.push_back(InputList(GuyInput(false, true, false, false, false, false, Ability::NO_ABILITY, FrameID(), 0, 0), 0));
        inputReplay.push_back(InputList(GuyInput(false, false, false, false, false, true, Ability::TIME_JUMP, FrameID(35, UniverseID(20000)), 0, 0), -1));
