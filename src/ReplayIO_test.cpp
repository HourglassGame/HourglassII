...
namespace {
    bool testReplaySavingAndLoading()
    {
        ...
        inputReplay.push_back(InputList(false, true, false, false, false, NO_ABILITY, FrameID(), 0, 0));
        inputReplay.push_back(InputList(false, true, false, false, false, NO_ABILITY, FrameID(), 0, 0));
        inputReplay.push_back(InputList(false, false, false, false, false, TIME_JUMP, FrameID(35, UniverseID(20000)), 0, 0));
