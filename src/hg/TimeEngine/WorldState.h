...
#include "hg/PhysicsEngine/PhysicsEngine.h"
#include "FrameUpdateSet.h"
#include "ConcurrentTimeSet.h"
#include "ArrivalDepartures/InputList.h"
...
public:
	...
	bool isInPast(Frame* frame, unsigned speedOfTimeFilter, unsigned guyFrameNumber, TimeDirection guyDirection);
