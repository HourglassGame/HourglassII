...
#include "hg/TimeEngine/ArrivalDepartures/InitialGuy.h"
#include "hg/PhysicsEngine/TriggerSystem/TriggerOffsetsAndDefaults.h"
...
template<>
BoxType to<BoxType>(lua_State *L, int index);

template<>
bool isValid<BoxType>(lua_State *L, int index);
